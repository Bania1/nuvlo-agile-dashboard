...
\begin{itemize}
    ...
    \item \textbf{Administrador o perfil técnico}: persona encargada de configurar aspectos técnicos de la aplicación, supervisar logs y mantener el correcto funcionamiento del sistema.
\end{itemize}
...
RF-03 & Must & El sistema debe permitir ejecutar procesos de sincronización de datos bajo demanda. & Prueba funcional de sincronización manual. \\
RF-04 & Should & El sistema debería permitir programar sincronizaciones periódicas. & Prueba funcional de planificación de sincronizaciones. \\
...
RNF-06 & Must & El sistema debe minimizar el impacto de los límites de uso de servicios externos mediante estrategias de control de acceso, reducción de peticiones o almacenamiento temporal. & Pruebas de integración y revisión de llamadas externas. \\
...
RI-07 & Must & El sistema debe incluir un conjunto mínimo de datos de prueba o demostración que permita validar su comportamiento en ausencia de conexión con fuentes reales. & Proyectos, incidencias, transiciones, sprints y métricas simuladas. & Sistema propio \\
...
A partir de los requisitos funcionales se identifican los principales casos de uso del sistema. Esta primera relación sirve como base para elaborar posteriormente el diagrama de casos de uso y las descripciones detalladas que se consideren necesarias. En una fase posterior, cada caso de uso podrá completarse con actores, precondiciones, flujo principal, flujos alternativos y postcondiciones.
...
CU-03 & Sincronizar datos de Jira & El usuario ejecuta una sincronización bajo demanda para importar o actualizar datos desde Jira Cloud. \\
CU-04 & Configurar parámetros de métricas & El usuario define estados de inicio y fin, campos de esfuerzo y otros parámetros necesarios para calcular métricas. \\
...
CU-08 & Consultar alertas & El usuario revisa alertas activas e históricas generadas por el sistema. \\
CU-09 & Consultar logs del sistema & El usuario o perfil técnico consulta eventos relevantes del sistema para diagnóstico y seguimiento. \\
\bottomrule
\end{longtable}
\vspace{0.45em}
}
