...
RF-02, RF-20 & Parcial & Filtros rápidos por estado, tipo y búsqueda textual en dashboard. La selección avanzada por tablero, sprint, etiquetas y rango temporal queda como mejora posterior. & E2E y revisión UI \\
...
RF-06 & Parcial & El dashboard muestra avisos de calidad de datos y limitaciones de changelog/sprints; la detección exhaustiva de inconsistencias queda como mejora. & Revisión funcional \\
RF-07, RF-08, RI-08 & Parcial & El backend almacena ámbitos de análisis y percentiles; la configuración completa desde UI queda pendiente de ampliación. & Revisión técnica \\
RF-09, RF-11--RF-15, RI-09 & Cumplido & Cálculo de WIP, Velocity, Lead Time, Cycle Time, media y percentiles con dataset offline y datos sincronizados. & Unitarias y E2E \\
RF-10, RF-16, RF-17, RF-18, RF-23 & Futuro & Requisitos de mejora no imprescindibles para el MVP: Deployment Frequency, métricas Scrum/Kanban adicionales, eventos manuales y modo presentación específico. & No aplicado al MVP \\
RF-19, RF-21, RF-22, RNF-01 & Cumplido & Dashboard responsive, widgets configurables, ayudas contextuales y capturas de escritorio/móvil. & E2E, revisión responsive y capturas \\
...
RF-27, RF-28, RNF-04 & Cumplido & Vista de actividad con logs de autenticación, sincronización, alertas y retención. Figura~\ref{fig:manual-actividad-jira}. & Integración y revisión funcional \\
RF-29--RF-31, RNF-05 & Cumplido & OAuth 2.0 3LO con Atlassian, cookies \texttt{httpOnly}, CSRF, PKCE y cifrado de tokens OAuth en PostgreSQL. & Revisión de código e integración \\
RNF-02, RNF-03, RNF-06, RNF-07, RNF-09, RNF-10, RNF-11 & Cumplido & Persistencia normalizada, Redis con TTL, política de retención, estructura monorepo, documentación técnica y pruebas automatizadas. & Unitarias, integración y revisión técnica \\
RNF-08 & Parcial & La arquitectura permite evolución incremental, pero no se han ejecutado pruebas de carga completas. & Revisión técnica \\
RI-07 & Cumplido & Dataset offline generado desde CSV/script y capturas demo reproducibles en \texttt{img/app-demo}. & E2E y capturas demo \\
\bottomrule
\end{longtable}
\vspace{0.45em}
}

Los requisitos marcados como parciales o futuros no impiden la existencia de un MVP funcional, pero delimitan claramente el trabajo restante y evitan presentar como completadas funcionalidades que todavía requieren desarrollo adicional.
...
\begin{itemize}
    ...
    \item \textbf{Servidor web / hosting frontend}: aloja el artefacto frontend compuesto por los recursos \texttt{HTML}, \texttt{CSS} y \texttt{JavaScript} de la aplicación.
    ...
    \item \textbf{Base de datos del sistema}: conserva la información persistente, incluyendo datos sincronizados, configuraciones, métricas calculadas, alertas y logs.
    \item \textbf{Atlassian Cloud}: agrupa los servicios externos usados por el sistema. \texttt{Atlassian OAuth} permite autenticar al usuario y \texttt{Jira Cloud API} proporciona los datos de proyectos, tableros, sprints e incidencias.
\end{itemize}
