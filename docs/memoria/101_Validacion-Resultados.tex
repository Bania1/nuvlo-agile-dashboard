...
Configuración avanzada y métricas futuras & Parcial/Futuro & Configuración básica disponible; quedan como ampliación requisitos no imprescindibles clasificados como \textit{Should Have} o \textit{Could Have}, entre ellos la configuración avanzada completa, \textit{Deployment Frequency} y más métricas de flujo. \\
\bottomrule
\end{longtable}
\vspace{0.45em}
}
