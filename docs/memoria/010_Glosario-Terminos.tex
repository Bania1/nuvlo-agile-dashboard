...
MVP & Siglas de \textit{Minimum Viable Product}, traducido como producto mínimo viable. Hace referencia a una primera versión funcional que cubre los requisitos imprescindibles y permite validar la propuesta antes de incorporar ampliaciones. \\
CI/CD & Siglas de \textit{Continuous Integration} y \textit{Continuous Delivery/Deployment}. Se refiere a prácticas de automatización para compilar, probar o desplegar cambios de forma repetible. \\
ORM & Siglas de \textit{Object-Relational Mapping}. En Nuvlo se utiliza Prisma como capa de acceso a PostgreSQL para trabajar con entidades del dominio sin escribir todas las consultas SQL manualmente~\cite{PrismaDocs}. \\
TTL & Siglas de \textit{Time To Live}. Indica el tiempo durante el que un dato temporal permanece válido antes de expirar automáticamente, especialmente en Redis~\cite{RedisDocs}. \\
\bottomrule
\end{longtable}
\vspace{0.45em}
}
