...
Scrum & Marco de trabajo ágil basado en iteraciones, roles, eventos y artefactos. Se usa como referencia para interpretar conceptos como sprint, planificación, revisión y Velocity~\cite{ScrumGuide2020}. \\
...
WIP & \textit{Work in Progress}. Representa el trabajo que se encuentra en curso en un momento determinado. Es útil para detectar sobrecarga o acumulación de tareas en el flujo~\cite{Anderson2010Kanban}. \\
Velocity & Métrica usada habitualmente en Scrum para observar el trabajo completado por sprint o periodo. En Nuvlo se calcula a partir del esfuerzo disponible o, en su defecto, del número de incidencias completadas~\cite{ScrumGuide2020}. \\
Lead Time & Tiempo transcurrido desde la creación de una incidencia hasta su finalización. Permite analizar el tiempo total que una unidad de trabajo tarda en recorrer el sistema~\cite{Anderson2010Kanban}. \\
Cycle Time & Tiempo transcurrido desde que una incidencia entra en trabajo activo hasta que se completa. Es útil para analizar la eficiencia del flujo una vez iniciado el trabajo~\cite{Anderson2010Kanban}. \\
Dashboard & Vista de resumen que agrupa indicadores, gráficos y avisos para facilitar la interpretación del estado de un proyecto. En Nuvlo es la pantalla principal de análisis. \\
Jira Cloud & Herramienta de Atlassian utilizada como fuente principal de datos de proyectos, incidencias, sprints y cambios de estado~\cite{AtlassianJira,AtlassianJiraRestV3}. \\
API REST & Interfaz de comunicación HTTP utilizada por Nuvlo para consultar datos de Jira Cloud desde el backend~\cite{AtlassianJiraRestV3}. \\
