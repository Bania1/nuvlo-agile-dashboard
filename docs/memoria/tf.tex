...
% --------------------------------------------------
\documentclass[a4paper,12pt,twoside,openany,final]{book}
...
\include{001_autoria}
\include{002_resumen}
\include{005_Agradecimientos}
%\phantomsection
%\addcontentsline{toc}{section}{Índice general}
\tableofcontents
\listoffigures
\listoftables
\include{010_Glosario-Terminos}
...
\include{011_Introduccion}
%\include{020_Definicion-Problema} % ejemplo con subdivisiones en ficheros del capitulo
\include{021_Definicion-Problema}
\include{031_Objetivos}
\include{041_Antecedentes}
\include{051_Planificacion-Temporal}
\include{061_Restricciones-Alternativas}
\include{065_Recursos-Utilizados}
% \include{031_ElTercero}
% \include{041_Cuarto}
\include{071_Requisitos}
\include{075_Analisis}
\include{081_Diseno-Arquitectura}
\include{091_Implementacion}
\include{101_Validacion-Resultados}
\include{111_Conclusiones}
...
\appendix
\include{321_AnexoManualUsuario}
\include{331_AnexoManualCodigo}
\include{341_AnexoUsoIA}
