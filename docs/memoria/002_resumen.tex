...
Este Trabajo Fin de Grado propone el desarrollo de un sistema web de visualización de métricas para equipos ágiles que trabajan con Scrum y Kanban. La herramienta permitirá centralizar, analizar y mostrar indicadores clave como \textit{Velocity}, \textit{Cycle Time}, \textit{Lead Time} y \textit{WIP}, con el objetivo de mejorar la toma de decisiones basada en datos y favorecer la mejora continua.
...
Métricas ágiles, Scrum, Kanban, \textit{dashboard}, visualización de datos, mejora continua, Jira, analítica de software.
